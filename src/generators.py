...
class TortueInMemoryGenerator(Sequence):
    'Construct sample_data iterator for in memory training that handle on the fly sample_data augmentation with albumentations'
...
class TubTo3DGenerator(Sequence):
    '''
    Construct sample_data iterator that export images batches for 3D convnet training.
    '''
